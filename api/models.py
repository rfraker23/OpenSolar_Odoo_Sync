...
class OpenSolarModule(models.Model):
    project = models.ForeignKey(OpenSolarProject, on_delete=models.CASCADE, related_name='modules', null=True)
    manufacturer_name = models.CharField(max_length=255)
    code = models.CharField(max_length=255)
    quantity = models.PositiveIntegerField()

    def __str__(self):
        return f"{self.manufacturer_name} {self.code} (x{self.quantity})"


class OpenSolarInverter(models.Model):
    project = models.ForeignKey(OpenSolarProject, on_delete=models.CASCADE, related_name='inverters', null=True)
    manufacturer_name = models.CharField(max_length=255)
    code = models.CharField(max_length=255)
    quantity = models.PositiveIntegerField()
...
class OpenSolarBattery(models.Model):
    project = models.ForeignKey(OpenSolarProject, on_delete=models.CASCADE, related_name='batteries', null=True)
    manufacturer_name = models.CharField(max_length=255)
    code = models.CharField(max_length=255)
    quantity = models.PositiveIntegerField()
